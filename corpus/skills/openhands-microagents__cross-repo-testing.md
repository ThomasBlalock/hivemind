---
id: openhands_microagents__cross-repo-testing
title: 'Cross-Repo Testing: SDK ↔ OpenHands Cloud'
description: '--- name: cross-repo-testing description: This skill should be used
  when the user asks to "test a cross-repo feature", "deploy a feature branch to staging",
  "test SDK against OH Cloud", "e2e test a cloud workspace feature", "test provider
  tokens", "test secrets inheritance", or w'
triggers:
- skill
- name
- cross-repo-testing
...
- this
- should
source: OpenHands/OpenHands@e7b5e3079592a1cffb3fb64b8e0813b007ebbb2f
---
