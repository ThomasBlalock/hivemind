---
id: openhands_microagents__documentation
title: Documentation Guidelines
description: '--- name: documentation type: knowledge version: 1.0.0 agent: CodeActAgent
  triggers: - documentation - docs - document ---'
triggers:
- documentation
- name
- type
