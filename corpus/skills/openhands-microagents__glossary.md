---
id: openhands_microagents__glossary
title: OpenHands Glossary
description: The core AI entity in OpenHands that can perform software development
  tasks by interacting with tools, browsing the web, and modifying code.
triggers:
- glossary
- core
- entity
